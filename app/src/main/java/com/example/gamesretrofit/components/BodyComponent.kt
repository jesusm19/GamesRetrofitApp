...
@Composable
fun MainTopBar(
    title: String, showBackButton: Boolean = false, onClickBackButton: () -> Unit,
    onClickActions: () -> Unit,
) {
    TopAppBar(
        title = {
        ...
        colors = TopAppBarDefaults.mediumTopAppBarColors(
            containerColor = Color(CUSTOM_COLOR)
        ),
        navigationIcon = {
            if (showBackButton) {
...
@Composable
fun CardGame(gameModel: GameModel, onClick: () -> Unit) {
    ...
    Card(
        ...
        Column {
            MainImage(image = gameModel.background_image)
        }
